      ...
      <div className="flex items-center justify-between w-full px-6">
        ...
        <div className="hidden lg:flex gap-4">
          ...
          <div className="group relative">
            ...
            <span className="absolute top-10 left-[50%] -translate-x-[50%] z-20 origin-left scale-0 px-3 rounded-lg border border-gray-400 bg-black-400 py-2 text-sm font-bold shadow-md transition-all duration-300 ease-in-out group-hover:scale-100 text-white">
              Github
            </span>
          </div>
          <div className="group relative">
